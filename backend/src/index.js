...
app.use((req, res, next) => {
  ...
  // Disable caching for API and HTML files to prevent browser caching of stale data
  if (req.path.startsWith('/api') || req.path === '/' || req.path.endsWith('.html') || !req.path.includes('.')) {
